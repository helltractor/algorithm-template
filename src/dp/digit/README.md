...
> Author: 灵茶山艾府
> Link: https://leetcode.cn/problems/total-waviness-of-numbers-in-range-ii/solutions/3839571/shang-xia-jie-shu-wei-dppythonjavacgo-by-74vp/
...
def dfs(i: int, limit_low: bool, limit_high: bool) -> int:
    ...
    hi = high[i] if limit_high else 9
    is_num = not limit_low or i > diff  # 是否存在前导零
